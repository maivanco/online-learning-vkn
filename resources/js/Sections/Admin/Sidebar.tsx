...
export default function Sidebar() {
    ...
    const navLinks = [
        ...
        {
            label: 'Students & CCCD (Học viên)',
            href: admin_url('students'),
            icon: (
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div>
                ...
                <div className="p-5 border-b border-stone-800/80 bg-stone-950/40">
                    <Link href="/" className="flex items-center gap-3">
                        <div className="w-9 h-9 rounded-lg bg-amber-500/20 border border-amber-500/30 flex items-center justify-center text-amber-400 font-serif font-bold text-lg">
                            VK
                        </div>
                        <div>
